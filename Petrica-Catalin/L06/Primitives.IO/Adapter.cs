...
namespace Primitives.IO
{
    ...
    public abstract class Adapter<O, R, S> : IInterpreter<S>, IAdapter<O, R>
    {
        ...
        public virtual Task Assertions(object[] path, O cmd, R result, S state) => throw new Exception("In order to have the tests properly working, provide some Asserts and override the Assertions() in your Adapter.cs");
